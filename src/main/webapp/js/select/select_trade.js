					...
					"custom.combobox2",
					{
						...
						_createAutocomplete : function() {
							...
							this.input = $("<input>")
									...
									.attr("title", "")
									.addClass(
											"custom-combobox-input2 ui-widget ui-widget-content ui-state-default ui-corner-left")
									.autocomplete({
										delay : 0,
										minLength : 0,
						...
						_createShowAllButton : function() {
							...
							$("<a>").attr("tabIndex", -1).attr("title",
								...
								text : false
									...
									"custom-combobox-toggle2 ui-corner-right")
									.mousedown(
											function() {
...
$(function() {
	$(".selecttrade2").combobox2();
	$(".selecttrade2")
			.combobox2(
					{
						select : function() {
							var input = $(".custom-combobox-input2");
							if ($(".selecttrade2").val() != 0) {
								input.css('box-shadow', '0 0 5px #5cd053');
								input
										.css('background',
												'#fff url(/BoMa/img/valid.png) no-repeat 98% center');
								input.css('border-color', '#28921f');
							} else {
