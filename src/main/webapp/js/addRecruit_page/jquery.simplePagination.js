		...
		init: function(options) {
			var o = $.extend({
				...
				onPageClick: function(pageNumber, event) {
					...
					$.ajax({
						url:"/BoMa/recruit/showAllRecruitsAjax?currentPage="+pageNumber+"&totalPage="+this.pages,
						method : "get",
						dataType:"json",
							...
							if(data.result!="false") {
								...
								for(var i=0;i<recruits.length;i++) {
									value +="<table  class=\"recruit"+recruits[i].id+"\"><tr><td style=\"width: 60%\" colspan=\"6\"><h1>"
										...
										+"<tr><td colspan=\"10\"><hr style=\"border: none; border-top: 5px ridge #12d212;\"></td></tr>"
